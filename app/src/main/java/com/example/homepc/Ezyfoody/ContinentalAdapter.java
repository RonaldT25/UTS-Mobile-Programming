        ...
        cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Contiquantity != 0) { //if quan < 0 or equals to 0
                    if (Contipos == 0) {
                        boolean isinserted = mydb.Add_to_Cart("Salsa",String.valueOf(Contiquantity),String.valueOf(30000*Contiquantity));
                        if (isinserted)
                        {
                            int price = 1; //price * quantity = total price
                            Contiorder_details[i] = "Id " + Conticounter + " Salsa Price Rp " + 30000 * Contiquantity + " ";
                    ...
                    if (Contipos == 1) {
                        boolean isinserted =  mydb.Add_to_Cart("Arabic Pizza",String.valueOf(Contiquantity),String.valueOf(115000*Contiquantity));
                        if (isinserted)
                        {
                            int price = 1;
                            Contiorder_details[i] = "Id " + Conticounter + " Arabic Pizza Price Rp " + 115000 * Contiquantity + " ";
                            Conticounter++;
                            i++;
                            Contiquantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (Contipos == 2) {
                        boolean isinserted = mydb.Add_to_Cart("Macaroni ",String.valueOf(Contiquantity),String.valueOf(25000*Contiquantity));
                        if (isinserted)
                        {
                            int price = 1;
                            Contiorder_details[i] = "Id : " + Conticounter + " Macaroni Price Rp " + 25000 * Contiquantity + " ";
                            Conticounter++;
                            i++;
                            Contiquantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (Contipos == 3) {
                        ...
                        boolean isinserted = mydb.Add_to_Cart("Pan Burger",String.valueOf(Contiquantity),String.valueOf(50000*Contiquantity));
                        if (isinserted)
                        {
                            int price = 1;
                            Contiorder_details[i] = "Id " + Conticounter + " Pan Burger Price Rp " + 50000 * Contiquantity + " ";
                            Conticounter++;
                            i++;
                            Contiquantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
